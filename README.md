...
- **Node.js** v22.16.0
- **MongoDB** (база даних)
- **EAS Build** (збірка Android APK)

## 📱 Функціонал

- Управління маршрутами водіїв
- Відстеження прогресу рейсів
- Підрахунок пробігу за місяць
- Перегляд новин та інструкцій
- Форми для водіїв (звіти, відпустки)
...
## 🎯 Що станеться після оновлення БД:

### У користувачів з встановленою версією (наприклад 1.2.3):
1. Запускають додаток
2. Бачать блокуючий екран "Вийшла нова версія застосунку"
3. Натискають "Завантажити оновлення"
4. Браузер відкриває посилання на сервер
5. APK завантажується автоматично
6. Встановлюють оновлення (токен зберігається!)

### У користувачів які НЕ запускають додаток:
- Просто встановлюють APK з повідомлення
- Оновлення відбувається без блокування
